...
CREATE TABLE IF NOT EXISTS `comunas` (
  ...
  CONSTRAINT `comunas_region_id_foreign` FOREIGN KEY (`region_id`) REFERENCES `regiones` (`id`)
...
CREATE TABLE IF NOT EXISTS `votos` (
  ...
  `como` json NOT NULL,
  KEY `id` (`id`),
  KEY `votos_comuna_id_fk` (`comuna_id`),
  KEY `votos_candidato_id_fk` (`candidato_id`),
  CONSTRAINT `votos_candidato_id_fk` FOREIGN KEY (`candidato_id`) REFERENCES `candidatos` (`id`),
  CONSTRAINT `votos_comuna_id_fk` FOREIGN KEY (`comuna_id`) REFERENCES `comunas` (`id`)
